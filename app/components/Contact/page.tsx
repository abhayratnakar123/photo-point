        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0 sm: hidden lg:flex lg:flex-col">
                <span className="block mb-4 text-base font-semibold text-primary text-4xl ">
                  Contact Us
                </span>
                <h2 className=" lg:flex sm: hidden rounded-md items-center justify-center text-center dark:text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="text-blue-700 bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative bg-white p-8 dark:bg-dark-2 lg:mt-0 sm: mt-[118px]">
